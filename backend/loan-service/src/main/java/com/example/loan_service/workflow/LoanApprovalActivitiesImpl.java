...
public class LoanApprovalActivitiesImpl implements LoanApprovalActivities {
    ...
    @Override
    public String createLoanAccount(LoanRequestDTO loanData) {
    ...
    @Override
    public String disburseLoan(CommonDisburseRequest disburseReq ) {
    ...
    @Override
    public void approveLoanInDatabase(Long loanId) {
