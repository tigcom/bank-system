...
public class CachingRedisConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory redisConnectionFactory, ObjectMapper objectMapper) {
        ...
        Jackson2JsonRedisSerializer<Repayment> repaymentSerializer =
                new Jackson2JsonRedisSerializer<>(objectMapper, Repayment.class);
        ...
        cacheConfigs.put("repaymentById", defaultConfig.entryTtl(Duration.ofMinutes(5))
                .serializeValuesWith(RedisSerializationContext.SerializationPair.fromSerializer(repaymentSerializer)));
